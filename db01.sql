...
(10, '轉知:教育是人類升沉的樞紐-2013教師生命成長營', 1);
...
INSERT INTO `menu` (`id`, `text`, `url`, `big_id`, `sh`) VALUES
(2, 'text_mid', '?do=news', 1, 1),
(4, 'text_mid', '?do=news', 3, 1),
(5, '管理登入', '?do=admin', 0, 1),
(6, '網站首頁', 'index.php', 0, 1),
(8, '更多內容', '?do=news', 6, 1),
(9, 'ABC', 'abc', 0, 1),
(14, 'a', 'b', 9, 1),
(15, 'aaaa', 'bbbb', 9, 1);
...
(6, '01B01.jpg', '卓越科技大學校園資訊系統', 0),
(9, '01B04.jpg', '卓越科技大學校園資訊系統', 1),
(10, '01B03.jpg', '卓越科技大學校園資訊系統', 0),
(12, '01B02.jpg', '卓越科技大學校園資訊系統', 0);
