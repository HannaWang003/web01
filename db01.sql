...
INSERT INTO `menu` (`id`, `text`, `href`, `big_id`, `sh`) VALUES
(1, '管理登入', 'index.php?do=admin', 0, 1),
(2, '網站首頁', 'index.php', 0, 1),
(4, '更多內容', 'index.php?do=news', 2, 1);
