...
<div style="width:99%; height:87%; margin:auto; overflow:auto; border:#666 1px solid;">
    ...
    <form method="post" action="./api/edit_admin.php" method="post">
        <table width="100%">
            <tbody>
                ...
                <tr>
                    ...
                    <th><?=$Menu->count(['big_id'=>$row['id']])?></th>
                    ...
                    <th><input type="button" value="編輯次選單"
                            onclick="op('#cover','#cvr','./model/submenu.php?id=<?=$row['id']?>')"></th>
        ...
        <table style="margin-top:40px; width:70%;">
            <tbody>
                <tr>
                    <td width="200px"><input type="button" onclick="op('#cover','#cvr','./model/menu.php')"
                            value="新增主選單"></td>
