<div style="width:99%; height:87%; margin:auto; overflow:auto; border:#666 1px solid;">
    ...
    <form method="post" action="./api/menu.php?do=menu">
        <table width="100%">
            <tbody>
                <tr class="yel">
                ...
                ?>
                    <tr>
                        ...
                        <td><input type="button" value="編輯次選單"
                                onclick="op('#cover','#cvr','./modal/submenu.php?do=menu&id=<?= $row['id'] ?>')">
                        </td>
                    </tr>
        ...
        <table style="margin-top:40px; width:70%;">
            <tbody>
                <tr>
                    <td width="200px"><input type="button" onclick="op('#cover','#cvr','./modal/menu.php?do=menu')"
                            value="新增主選單">
                    </td>
