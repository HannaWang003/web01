...
<form method="post" action="./api/menu.php">
    <table width="100%">
        <tbody>
            <tr class="yel">
            ...
            <tr>
                ...
                <td><input type="button" value="編輯次選單"
                        onclick="op('#cover','#cvr','./modal/submenu.php?id=<?=$row['id']?>')"></td>
    ...
    <table style="margin-top:40px; width:70%;">
        <tbody>
            <tr>
                <td width="200px"><input type="button" onclick="op('#cover','#cvr','./modal/menu.php')" value="新增主選單">
                </td>
