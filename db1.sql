...
(6, '轉知臺北教育大學與臺灣師大合辦第11屆麋研齋全國硬筆書法比賽活動', 1);
...
(2, 'mid', 'mid_url', 1, 1),
(3, '管理登入', '?do=admin', 0, 1),
(4, '網站首頁', 'http://127.0.0.1/index.php', 0, 1),
(8, '更多內容', 'http://127.0.0.1/index.php?do=news', 4, 1);
